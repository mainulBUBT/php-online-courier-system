...
//create some sql statement             
        $sql = "SELECT * FROM  `employee` WHERE  `emp_name` =  '" . $name . "' AND  `emp_pass` =  '" . $h_upass . "'";
        ...
        //IF theres a result
            if ( $result->num_rows > 0) {
                ...
                $_SESSION['SMEMBER_ID']  = $found_user['id']; 
                $_SESSION['SNAME'] = $found_user['emp_name']; 
           
             ?>    <script type="text/javascript">
                      //then it will be redirected to index.php
                      window.location = "staff_space.php";
                  </script>
             <?php        
  ...
  echo "<script> location.href='staff_space.php' </script>";
} //------------------------- Condition for users--------------------//
...
<html lang="en">
  <head>
    ...
    <title>Staff Login | Fast Delivery</title>
</head>
<body>
   <!-- Navigation bar -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item">
        <a class="nav-link" href="user_login.php"><button type="button" class="btn btn-warning">Marchant Login</button></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admin_login.php"><button type="button" class="btn btn-danger">Admin Login</button></a>
      </li>
    </ul>
  </div>
</nav>
    ...
    <section id="banner"><div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6 mx-auto">
          <div class="card">
  <h5 class="card-header text-center">Staff Login</h5>
  <div class="card-body">
